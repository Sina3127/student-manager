...
from college.views import ContractsView, ContractDetailsView, AgreementView, AgreementDetailsView, AgreementListView
...
urlpatterns = [
    ...
    path('agreement/', AgreementListView.as_view(), name='agreements'),
